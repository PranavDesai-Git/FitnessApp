## About
**MOVEMENTOR** is a project which is aimed to improve the fitness and diets of a person.It is also used to track the eating habits and the fitness routine of the user.This project mainly focus on the two things: Posture correction and Diet of the user.
...
- POSTURE correction using the camera.
- personalized DIET planning for seperate user.
- MEAL photo analysis.
